## Answering the Question: What is the expected number of cards until you take an ace?

## write a for loop from 1 to 48 where you find the expected value of the number of cards until you see the first ace
